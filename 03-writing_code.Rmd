...
- Apply strategies for using AI to build functions, debug code, understand error messages, choose the proper programming language, and plan out a multistep programming project.
