...
We do not believe AI chatbots will replace software developers. An AI is only as good as the training data behind it and the human using it. For the time being and for the foreseeable future, humans will likely remain at the forefront of programming innovation, albeit with the support of AI. This is because new code is typically built on top of existing code that has already been written by humans. However, AI can play an important role in helping developers to work more efficiently and effectively, by providing insights, catching errors, and automating repetitive tasks. As AI technology continues to advance, it's likely that its role in programming will only become more significant. 

We _do_ think the roles programmers play in software development are changing, and some of the skills needed to work in this new world are slightly different from the ones  needed before. Rather than being solely focused on programming syntax, programmers may need to develop a more refined ability to construct queries that enable AI bots to create the desired workflows. Other critical skills, such as debugging, troubleshooting, and documentation, will remain valuable, and can be enhanced through the use of AI. Moreover, AI creates new opportunities and niches for tasks that were previously difficult, time-consuming, or impossible. As a result, this is an exciting time for those working in programming, with great potential to explore new and innovative solutions. We believe that AI chatbots are unlikely to replace software developers entirely. While AI can be powerful and useful, it is only as good as the training data behind it and the human using it. Therefore, for the time being and the foreseeable future, humans will likely remain at the forefront of programming innovation, with AI providing valuable support. As new code is often built on top of existing code written by humans, it is unlikely that AI will fully replace the need for human programmers.
