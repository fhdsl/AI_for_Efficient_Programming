...
ottrpal::include_slide("https://docs.google.com/presentation/d/1MCNeSO4aOm1iESWDLOGTcx3aLEbnu8UttV0QGVAeafE/edit#slide=id.g2147eea86c5_0_0")
```
:::
...
1. Why would a progammer set up a section of code like this?
...
1. How are these variables initialized?
...
1. What are some other variables that could be added to this command to customize the output?
