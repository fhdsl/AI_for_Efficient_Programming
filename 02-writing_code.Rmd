...
## Example Two: Creating a Multistep Game

Let's say we want to create software that plays Blackjack. There are multiple steps involved in creating such a program, and AI can help us identify and refine them.
...
Well, I'm convinced. As we start building this code, we will use Python. (You are, of course, more than welcome to do it in Java, but the rest of the example will be in Python.)

### step Three: Chunking It Out



### Step Four: Slowly Adding Complexity
