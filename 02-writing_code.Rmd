...
### Step One: Chunking It Out

### Step Two: Slowly Adding Complexity
...
## Example Three: Writing a Multistep Program

Let's say we want to create software that plays the card game blackjack. There are multiple steps involved in creating such a program, and AI can help us identify and refine them.
...
### Step Two: Selecting a Language

Let's ask Claude-instant again for some recommendations on the appropriate languages for our proposed blackjack game. (Pro tip: the various AI bots all keep track of your previous queries, so you don't have to restate your goal for the software if you're continuing the conversation.)
...
### Step Three: Knowing Where to Start
