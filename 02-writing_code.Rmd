...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Phind offers several ways to write functions that reverse strings using Python."}
...
Phind offers you a variety of ways to do this, but unfortunately they're all in the language Python. Because we didn't include a programming language in our query, Phind picked one for us. Let's refine our query a little.

:::{.query}
"How do I write a function using bash that reverses the letters in a string?"
:::

```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Phind offers several ways to reverse strings using Bash."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1MCNeSO4aOm1iESWDLOGTcx3aLEbnu8UttV0QGVAeafE/edit#slide=id.g230c4a00725_31_92")
```




Once again, Phind has come through with multiple options. Now let's say you knew you wanted to write a function like this, but you half-remembered that you could do it with awk. You can specify that in your query, too.

:::{.query}
"How do I write a function using awk that reverses the letters in a string?"
:::

```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Phind generates several approaches to writing a function that reverses strings using the awk command."}
...
Maybe you need to reverse the letters in a string, but you realize it's only the strings in the third column of your file. Let's add that requirement to our query.

:::{.query}
"How do I write a function using awk that reverses the letters in a string for the third column of my file?"
:::

```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Phind suggests code modifications that allow you to reverse strings that appear in the third column."}
...
## Example Three: Figuring Out a Common Task
...
## Example Four: Planning Your Program
...
## Example Five: Selecting a Language
